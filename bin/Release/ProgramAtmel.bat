...
REM .\atprogram.exe  -t atmelice -i SWD -d atsamd51j20a write --fuses -o 0x0804000 --values 38969afe
REM Program the application and the bootloader in one .hex file
.\atprogram.exe  -t atmelice -i SWD -d atsamd51j20a program -c -f "FlowLiteATSAMD51J20A.hex"
...
REM .\atprogram.exe  -t atmelice -i SWD -d atsamd51j20a write --fuses -o 0x0804000 --values 38969af6
pause
